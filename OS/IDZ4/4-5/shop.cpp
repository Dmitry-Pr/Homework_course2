...
void handle_command(message &mess, sockaddr_in from_addr) {
    if (mess.senderType == 0) { 
        ...
        if (mess.messageType == 0) { 
            ...
            std::cout << "Customer " << customer << " has been served" << std::endl;
        ...
        if (mess.messageType == 0) { 
            // Connection message
            std::cout << "Customer " << customer_id++ << " connected to shop" << std::endl;
            ...
            std::cout << "Customer " << customer << " is in queue in department " << department << std::endl;
